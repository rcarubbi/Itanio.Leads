...
Itanio.Leads.App = (function() {
    ...
    $private.newItem = function(e) {
        ...
        if (table.data("edit-mode") == "NewWindow") {
            ...
            $("#loading").show();
            $("#form-modal-container").load(action + "?" + $private.serializeJsonToQuerystring(customData),
                null,
                function() {
    ...
    $private.clickModalQuestionButton = function(e) {
        ...
        e.preventDefault();
        $private.postAction(action + "?" + $private.serializeJsonToQuerystring(ids), null, null, notification).done(
            function(data) {
    ...
    $private.postAction = function(action, formData, formEncType, notification) {
        ...
        return $.ajax({
            ...
            contentType: (formEncType == "application/x-www-form-urlencoded"
                ? "application/x-www-form-urlencoded; charset=UTF-8"
                : (formEncType == "multipart/form-data" ? false : formEncType)),
